...
parser.add_argument('-model', type=str, default='Vgg16P',
                    help='model of CNN')
...
def main():
    ...
    #name experiment
    personal_name = "vgg16_not_pre_rgb"
    log_dir = "logs"
    if personal_name:
    ...
    writer.add_text('Info experiment',
                    ...
                    "\n\nrgb:{}"
                    "\n\nn_workers: {}"
                    "".format(args.model, args.batch_size, args.epochs, args.opt, args.lr, args.momentum,
